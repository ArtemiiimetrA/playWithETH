...
contract ArtyomLovesOlyaProxy is Initializable, ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize(uint256 initialSupply, uint256 maxSupply_) public initializer {
